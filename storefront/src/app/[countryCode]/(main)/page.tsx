...
export default async function Home(props: {
  ...
  return (
    <>
      ...
      {/* Featured Products */}
      <section className="py-16 bg-[#fdf4e5]">
        <div className="content-container">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-light text-[#7f5835] mb-2">
                Nuestras creaciones
              </h2>
            ...
            <LocalizedClientLink
              href="/store"
              className="hidden sm:inline-flex items-center gap-2 text-[#7f5835] font-medium hover:text-[#8B7355] transition-colors"
            >
              Ver todos
          ...
          <div className="relative">
            ...
            <div className="absolute right-0 top-0 bottom-4 w-8 bg-gradient-to-l from-[#fdf4e5] to-transparent pointer-events-none" />
          </div>
          ...
          <div className="sm:hidden text-center mt-8">
            <LocalizedClientLink
              href="/store"
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#7f5835] text-white font-medium rounded-lg hover:bg-[#8B7355] transition-colors"
            >
      ...
      {/* Trust Section */}
      <section className="py-12 bg-[#7f5835]">
        <div className="content-container">
      ...
      <section className="py-16 bg-white">
        <div className="content-container text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <LocalizedClientLink
              href="/store"
              className="inline-flex items-center justify-center px-8 py-4 bg-[#7f5835] text-white font-medium rounded-lg hover:bg-[#8B7355] transition-colors"
            >
              Explorar colección
            </LocalizedClientLink>
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-[#7f5835] text-[#7f5835] font-medium rounded-lg hover:bg-[#7f5835] hover:text-white transition-colors"
            >
