        ...
        <div className="max-w-3xl mx-auto prose prose-brown">
          ...
          <section className="mb-8">
            ...
            <ul className="text-[#8B7355] space-y-2">
              <li><strong className="text-[#7f5835]">Ejecución de contrato:</strong> Para procesar tus compras</li>
              <li><strong className="text-[#7f5835]">Consentimiento:</strong> Para comunicaciones comerciales</li>
              <li><strong className="text-[#7f5835]">Interés legítimo:</strong> Para mejorar nuestros servicios</li>
              <li><strong className="text-[#7f5835]">Obligación legal:</strong> Para cumplir con la normativa fiscal</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="text-[#8B7355] space-y-2">
              <li><strong className="text-[#7f5835]">Datos de compra:</strong> Durante la relación comercial y los años legalmente requeridos</li>
              <li><strong className="text-[#7f5835]">Datos de contacto:</strong> Hasta que solicites su supresión</li>
              <li><strong className="text-[#7f5835]">Cookies:</strong> Según su tipo (ver Política de Cookies)</li>
            </ul>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className="bg-[#fdf4e5] p-3 rounded">
                <p className="text-[#7f5835] font-medium text-sm">Acceso</p>
                <p className="text-[#8B7355] text-xs">Saber qué datos tenemos sobre ti</p>
              </div>
              <div className="bg-[#fdf4e5] p-3 rounded">
                <p className="text-[#7f5835] font-medium text-sm">Rectificación</p>
                <p className="text-[#8B7355] text-xs">Corregir datos incorrectos</p>
              </div>
              <div className="bg-[#fdf4e5] p-3 rounded">
                <p className="text-[#7f5835] font-medium text-sm">Supresión</p>
                <p className="text-[#8B7355] text-xs">Eliminar tus datos</p>
              </div>
              <div className="bg-[#fdf4e5] p-3 rounded">
                <p className="text-[#7f5835] font-medium text-sm">Oposición</p>
                <p className="text-[#8B7355] text-xs">Oponerte a ciertos tratamientos</p>
              </div>
              <div className="bg-[#fdf4e5] p-3 rounded">
                <p className="text-[#7f5835] font-medium text-sm">Portabilidad</p>
                <p className="text-[#8B7355] text-xs">Recibir tus datos en formato digital</p>
              </div>
              <div className="bg-[#fdf4e5] p-3 rounded">
                <p className="text-[#7f5835] font-medium text-sm">Limitación</p>
                <p className="text-[#8B7355] text-xs">Limitar el uso de tus datos</p>
              </div>
            </div>
            <p className="text-[#8B7355] mt-4 text-sm">
              Para ejercer estos derechos, escríbenos a <a href="mailto:hola@mis4nudos.com" className="text-[#7f5835] underline">hola@mis4nudos.com</a>
            </p>
          </section>
