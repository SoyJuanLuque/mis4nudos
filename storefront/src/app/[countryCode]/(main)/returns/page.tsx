        ...
        <div className="max-w-3xl mx-auto">
          ...
          <section className="mb-12">
            ...
            <p className="text-[#8B7355] mb-4">
              Para productos estándar (no personalizados), tienes <strong className="text-[#7f5835]">14 días</strong> desde
              la recepción para solicitar devolución si:
            </p>
            <ul className="space-y-2 text-[#8B7355]">
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-[#7f5835] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                <div className="w-8 h-8 bg-[#7f5835] text-white rounded-full flex items-center justify-center font-semibold flex-shrink-0">
                  1
                </div>
                <div>
                  <p className="text-[#7f5835] font-medium">Contacta conmigo</p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-[#7f5835] font-medium">Explícame el motivo</p>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <p className="text-[#7f5835] font-medium">Te indicaré los pasos a seguir</p>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-[#fdf4e5] p-4 rounded-lg">
                <p className="text-[#7f5835] font-medium mb-1">Otros motivos</p>
          ...
          <section className="mb-12">
            ...
            <p className="text-[#8B7355]">
              ...
              en un plazo de <strong className="text-[#7f5835]">5-10 días laborables</strong> por
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="inline-block bg-[#7f5835] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#8B7355] transition-colors"
              >
                Email
              </a>
            </div>
