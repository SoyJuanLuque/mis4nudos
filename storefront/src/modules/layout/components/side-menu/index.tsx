            ...
            <>
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  className="relative h-full flex items-center transition-all ease-out duration-200 focus:outline-none text-[#fdf4e5] hover:text-white"
                >
              ...
              >
                <PopoverPanel className="flex flex-col fixed left-0 top-0 w-full sm:w-80 h-screen z-[51] bg-[#fdf4e5] shadow-xl">
                  <div
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-8">
                        ...
                        <button
                          ...
                          onClick={close}
                          className="text-[#7f5835] hover:text-[#8B7355] transition-colors"
                        >
