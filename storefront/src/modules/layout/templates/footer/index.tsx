...
export default async function Footer() {
  ...
  return (
    <footer className="bg-[#fdf4e5] border-t border-[#E5DDD0] w-full">
          ...
          <div className="max-w-xs">
            ...
            <div className="flex gap-4 mt-4">
              <a href="https://instagram.com/mis4nudos" target="_blank" rel="noreferrer"
                 className="text-[#8B7355] hover:text-[#7f5835] transition-colors">
          ...
          <div className="text-small-regular gap-10 md:gap-x-16 grid grid-cols-2 sm:grid-cols-3">
            {productCategories && productCategories?.length > 0 && (
              <div className="flex flex-col gap-y-2">
                <span className="txt-small-plus text-[#7f5835] font-medium">
                  Categorías
                </span>
              ...
              <div className="flex flex-col gap-y-2">
                ...
                <ul className={clx("grid grid-cols-1 gap-2 text-[#8B7355] txt-small", {
                  ...
                  {collections?.slice(0, 6).map((c) => (
                    <li key={c.id}>
                      <LocalizedClientLink className="hover:text-[#7f5835]" href={`/collections/${c.handle}`}>
                        {c.title}
                      </LocalizedClientLink>
                    </li>
                  ))}
            ...
            <div className="flex flex-col gap-y-2">
              <span className="txt-small-plus text-[#7f5835] font-medium">Ayuda</span>
              <ul className="grid grid-cols-1 gap-y-2 text-[#8B7355] txt-small">
                <li>
                  <LocalizedClientLink href="/about" className="hover:text-[#7f5835]">
                    Sobre Nosotros
                  </LocalizedClientLink>
                </li>
                <li>
                  <LocalizedClientLink href="/contact" className="hover:text-[#7f5835]">
                    Contacto
                  </LocalizedClientLink>
                </li>
                <li>
                  <LocalizedClientLink href="/shipping" className="hover:text-[#7f5835]">
                    Envíos
                  </LocalizedClientLink>
                </li>
                <li>
                  <LocalizedClientLink href="/returns" className="hover:text-[#7f5835]">
                    Devoluciones
                  </LocalizedClientLink>
                </li>
                <li>
                  <LocalizedClientLink href="/privacy-policy" className="hover:text-[#7f5835]">
                    Política de Privacidad
                  </LocalizedClientLink>
                </li>
                <li>
                  <LocalizedClientLink href="/terms" className="hover:text-[#7f5835]">
