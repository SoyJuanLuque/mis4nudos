...
const InstagramSection = () => {
  const instagramUrl = "https://www.instagram.com/mis4nudos"
      ...
      <div className="content-container">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <span className="text-xl font-medium text-[#7f5835]">@mis4nudos</span>
          </div>
          <h2 className="text-3xl md:text-4xl font-light text-[#7f5835] mb-4">
            Síguenos en Instagram
          </h2>
          <p className="text-[#8B7355] text-lg max-w-2xl mx-auto">
            Descubre nuestras últimas creaciones, inspiración y el proceso detrás de cada pieza
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 md:gap-4">
          {instagramPosts.map((post) => (
            ...
            >
              ...
              {/* Hover overlay */}
              <div className="absolute inset-0 bg-[#7f5835]/0 group-hover:bg-[#7f5835]/60 transition-all duration-300 flex items-center justify-center">
                <svg
        ...
        <div className="text-center mt-10">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#833AB4] via-[#E4405F] to-[#FCAF45] text-white font-medium rounded-lg hover:opacity-90 transition-opacity"
          >
