      ...
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Tu pedido llegará en 3-5 días laborables a tu dirección de entrega
              o en la comodidad de tu hogar.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              ¿No es lo que esperabas? No te preocupes, contacta con nosotros
              y lo solucionamos.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Devuelve tu producto y te reembolsamos el dinero. Sin preguntas,
              haremos todo lo posible para que tu devolución sea sencilla.
            </p>
          </div>
        </div>
      </div>
